...
KNOWN_LICENSES = [
    ...
    License("BSD Zero Clause License", "0BSD", "License :: OSI Approved",),
    License(
    ...
    License("Adaptive Public License 1.0", "APL-1.0", None,),
    License(
    ...
    License(
        "Cryptographic Autonomy License 1.0", "CAL-1.0", "License :: OSI Approved",
    ),
    License(
    ...
    License(
        "Common Public Attribution License 1.0", "CPAL-1.0", "License :: OSI Approved",
    ),
    License(
    ...
    License(
        "CUA Office Public License v1.0", "CUA-OPL-1.0", "License :: OSI Approved",
    ),
    ...
    License(
        "Educational Community License v1.0", "ECL-1.0", "License :: OSI Approved",
    ),
    License(
        "Educational Community License v2.0", "ECL-2.0", "License :: OSI Approved",
    ),
    License(
        "Eiffel Forum License v1.0", "EFL-1.0", "License :: Eiffel Forum License (EFL)",
    ),
    License(
        "Eiffel Forum License v2.0", "EFL-2.0", "License :: Eiffel Forum License (EFL)",
    ),
    License("eGenix.com Public License 1.1.0", "eGenix", None),
    License("Entessa Public License v1.0", "Entessa", "License :: OSI Approved",),
    ...
    License("EU DataGrid Software License", "EUDatagrid", "License :: OSI Approved",),
    License(
    ...
    License("Fair License", "Fair", "License :: OSI Approved"),
    License("Fraunhofer FDK AAC Codec Library", "FDK-AAC", None),
    License("Frameworx Open License 1.0", "Frameworx-1.0", "License :: OSI Approved",),
    ...
    License("IPA Font License", "IPA", "License :: OSI Approved",),
    License(
        "IBM Public License v1.0",
        "IPL-1.0",
        "License :: OSI Approved :: IBM Public License",
    ),
    License("ISC License", "ISC", "License :: OSI Approved :: ISC License (ISCL)"),
    ...
    License("Lucent Public License Version 1.0", "LPL-1.0", "License :: OSI Approved",),
    License("Lucent Public License v1.02", "LPL-1.02", "License :: OSI Approved",),
    ...
    License(
        "LaTeX Project Public License v1.3c", "LPPL-1.3c", "License :: OSI Approved",
    ),
    ...
    License(
        "MIT License Modern Variant", "MIT-Modern-Variant", "License :: OSI Approved",
    ),
    License("MIT Open Group variant", "MIT-open-group", None),
    License("MIT +no-false-attribs license", "MITNFA", None),
    License(
        "Motosoto License", "Motosoto", "License :: OSI Approved :: Motosoto License",
    ),
    ...
    License("Microsoft Public License", "MS-PL", "License :: OSI Approved",),
    License("Microsoft Reciprocal License", "MS-RL", "License :: OSI Approved",),
    ...
    License("Multics License", "Multics", "License :: OSI Approved",),
    License("Mup License", "Mup", None),
    License(
        "Nara Institute of Science and Technology License (2003)", "NAIST-2003", None
    ),
    License("NASA Open Source Agreement 1.3", "NASA-1.3", "License :: OSI Approved",),
    License("Naumen Public License", "Naumen", "License :: OSI Approved",),
    ...
    License(
        "Non-Profit Open Software License 3.0", "NPOSL-3.0", "License :: OSI Approved",
    ),
    License("NRL License", "NRL", None),
    License("NTP License", "NTP", None),
    ...
    License("OCLC Research Public License 2.0", "OCLC-2.0", None,),
    ...
    License("Open LDAP Public License v2.8", "OLDAP-2.8", "License :: OSI Approved",),
    ...
    License(
        "OSET Public License version 2.1", "OSET-PL-2.1", "License :: OSI Approved",
    ),
    License("Open Software License 1.0", "OSL-1.0", "License :: OSI Approved",),
    License("Open Software License 1.1", "OSL-1.1", None),
    License("Open Software License 2.0", "OSL-2.0", "License :: OSI Approved",),
    License("Open Software License 2.1", "OSL-2.1", "License :: OSI Approved",),
    License(
    ...
    License("PHP License v3.0", "PHP-3.0", "License :: OSI Approved",),
    License("PHP License v3.01", "PHP-3.01", "License :: OSI Approved",),
    ...
    License("Reciprocal Public License 1.1", "RPL-1.1", "License :: OSI Approved",),
    License("Reciprocal Public License 1.5", "RPL-1.5", "License :: OSI Approved",),
    License(
    ...
    License("Simple Public License 2.0", "SimPL-2.0", "License :: OSI Approved",),
    License(
    ...
    License(
        "Upstream Compatibility License v1.0", "UCL-1.0", "License :: OSI Approved",
    ),
    License(
    ...
    License("X.Net License", "Xnet", "License :: OSI Approved :: X.Net License"),
    ...
    License("zlib License", "Zlib", "License :: OSI Approved :: zlib/libpng License"),
